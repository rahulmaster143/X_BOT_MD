...
const SUDO = process.env.SUDO || '919356730236';
...
const BOT_INFO = process.env.BOT_INFO || "RAHUL-POLICE-OFFICERS;RAHUL_JI;https://api.tioo.eu.org/file/zVEElY3ruylo.jpeg";
const URL = process.env.URL || "https://www.instagram.com/rahul,_hiran_60";
const AUDIO_DATA = process.env.AUDIO_DATA || "RAHUL-POLICE-OFFICERS;RAHUL_JI;https://api.tioo.eu.org/file/zVEElY3ruylo.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "X BOT MD;RAHUL MASTER";
